          ...
          <div style={{background:'white',borderRadius:'12px',padding:'2rem',width:'90%',maxWidth:'600px',maxHeight:'90vh',overflow:'auto'}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'1rem',marginTop:'1rem'}}>
              ...
              {modalType === 'group' && (<>
                ...
                <div><label style={labelStyle}>📷 Image URL</label><input style={inputStyle} value={editingItem.imageUrl||''} onChange={e=>setEditingItem({...editingItem,imageUrl:e.target.value})} placeholder='Paste image URL or leave empty' /></div>
